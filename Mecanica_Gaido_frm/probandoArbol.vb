...
'                ' Asumiendo que tienes un TextBox llamado txtCodDep
...
'        frmProductos.ubicacionrep = txtCodDep.Text

'        Me.Close()
'        txtCodDep.Text = ""
'        frmProductos.txtUbicacion.Text = frmProductos.ubicacionrep
'    End Sub
'End Class
